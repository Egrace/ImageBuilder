...
ImageProcessing::ImageBuilder
  ...
  .with_image(source: '/Users/Macmini/Downloads/3.png',
              width: 64, height: 64,
              x: 10, y: 10)
  .with_label(text: '| News', x: 80, y: 52,
              pointsize: 28, color: 'white')
  .with_area_text(text: "The Moscow government planned to allocate to the fund of Putin's ex-wife subsidies of 62 million a year",
